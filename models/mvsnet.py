...
class MVSNet(nn.Module):
    ...
    def forward(self, imgs, proj_matrices,depth_values):
        ...
        state1 = torch.zeros((B,gru1_output_channel,H,W),device=ref_feature.device)
        state2 = torch.zeros((B,gru2_output_channel,H,W),device=ref_feature.device)
        state3 = torch.zeros((B,gru3_output_channel,H,W),device=ref_feature.device)
